<div class="wrap">
  ...
  <ul>
    ...
    <li>Add "<?php echo esc_url(SALESFORCE__REDIRECT_URI); ?>" to the Callback URL in your app's Salesforce OAuth settings.</li>
  ...
  <?php else: ?>
    <a class="button-primary" href="<?php echo esc_url(site_url('/salesforce-login')); ?>" title="<?php esc_attr_e( 'Login' ); ?>"><?php esc_attr_e( 'Login' ); ?></a>
  <?php endif; ?>
